...
var ecpairToSigner_1 = require("./ecpairToSigner");
var ecc = __importStar(require("tiny-secp256k1"));
function signTransaction(psbtBase64, wif) {
    return __awaiter(this, void 0, void 0, function () {
        var psbt, ECPair, keyPair, signer, txHex;
        return __generator(this, function (_a) {
            psbt = bitcoin.Psbt.fromBase64(psbtBase64, { network: bitcoin.networks.testnet });
            ECPair = (0, ecpair_1["default"])(ecc);
            ...
            psbt.validateSignaturesOfAllInputs(function (publicKey, hash, signature) {
